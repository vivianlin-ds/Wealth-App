...
const MOVEMENT_CATEGORIES = ["High yield saving", "Cash", "401k", "HSA"];
const NO_COST_BASIS_CATEGORIES = ["High yield saving", "Cash", "401k", "Roth", "HSA"];
const RETIREMENT_CATEGORIES = ["401k", "Roth", "HSA"];
const state = {
    holdings: [],
    formMode: "new",
};
...
async function saveHolding(event) {
    ...
    const payload = {
        ...
        costBasis: isNoCostBasisCategory(elements.category.value) ? 0 : Number(elements.costBasis.value || 0),
